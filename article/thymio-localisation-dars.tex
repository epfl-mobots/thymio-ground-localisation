...
However, while several algorithms in this field require global localization, this capability is not yet available in low-cost robots without extern aids.
...
The main challenge of solving the localization problem on affordable mobile robots is the limited information content typical inexpensive sensors can provide and the constraints on the environment.
...
The system proposed in this paper builds on the idea of using information from the ground for absolute localization.
It is affordable because it only requires a low number of inexpensive infrared sensors onboard the robot, and a simple grayscale pattern on the ground.
Moreover, its performance is comparable with related work.
