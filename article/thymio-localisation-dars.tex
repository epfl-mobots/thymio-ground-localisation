...
For comparison, VideoCore\textsuperscript{\textregistered} IV, the built-in \textsc{gpu} in a Raspberry PI 3 (costing \EUR{33}), has a top performance of 28 \textsc{gflops}.
Assuming that due to limitations in bandwidth and dependencies between data it can only be used at 10\,\%, it could run a \textsc{gpu} version of our algorithm at 10\,Hz on a map of 1.8 by 1.8 meters with a resolution of 1\,cm.
