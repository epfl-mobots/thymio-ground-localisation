...
The reason is that using $\sigma_\mathrm{obs} = 0.5$ for the binary case was an arbitrary choice.

If instead, we use $\sigma_\mathrm{obs} = 0.15$ as measured on grayscale images, we have $p_\mathrm{correct} = 0.99957$.
