...
The main challenge of solving the localization problem on affordable mobile robots is the limited information content that inexpensive sensors can typically provide.
...
%Singh and Bedi~\cite{singh2013map} have used the ultrasound sensor of the LEGO Mindstorms NXT to localize a robot in a room.
...
In contrast, our system only relies on inexpensive onboard infrared sensors typically used as cliff detectors and on minimal modification of the environment: a poster or any textured ground.
