...
\label{fig:thymio}
\end{figure}
%FIXME: the child does not fit DARS
...
The generic Bayesian filter used to estimate the pose of the robot in the environment uses the following variables:
\begin{itemize}
...
\textbf{Observation model}. The robot has two infrared ground sensors measuring the grayscale value of the ground.
