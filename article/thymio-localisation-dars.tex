...
Moreover, this low bound would be attained with a perfect filter observing a perfect pattern.
...
\Fig{small-maps} shows the effect on the distance of convergence when the map size is reduced.
