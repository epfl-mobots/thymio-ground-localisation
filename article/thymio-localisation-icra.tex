...
In order to precisely measure the robot poses, a Vicon\footnote{http://www.vicon.com/} tracking system is used to provide this ground truth, with robot 2-D pose $x$, $y$ as well as the heading of the robot $\theta$.
