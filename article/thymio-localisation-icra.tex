...
This lack of absolute positionning limits their educational use, in particular for the study of geometry, physics, and engineering; but also the building of advanced behaviours, such as robots playing a theater piece.

This paper solves this problem.
We provide an obsolute positioning system using only approximate dead-reckoning and inexpensive infrared sensors measuring the grayscale intensity of the ground.
...
Finally, we show how grayscale images can be used as ground maps that allow the robot to localise.
