...
\item \texttt{linear}: The Robot simple goes straight along the x-axis of the map.
\end{itemize}
...
In run \texttt{normal~1}, the resolution of 18 is not enough to keep tracking the orientation at distance traveled 50\,cm and 80\,cm.
...
Stable localization on run \texttt{normal\,1} is only achieved after traveling 150\,cm.
