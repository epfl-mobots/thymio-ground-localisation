...
In \cite{pinto2012localization}, Extended Kalman Filter algorithm is conducted for the purpose of teaching undergraduate university students localization of mobile robots.
...
In \cite{singh2013map} a particle filter algorithm is used to solve robot localization problem with robot kidnapping using information from ultrasonic sensors.
