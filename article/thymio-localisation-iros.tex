...
To exploit the combination of individual perception of multiple robots, Kurazume and Nagata~\cite{kurazume1994cooperative} first raise the idea of cooperative positioning with multiple robots. 
...
This table shows the duration in second of one step for the different algorithms and parameters, averaged over the two first trajectories:

\vspace{.5em}

\noindent \begin{tabularx}{\columnwidth}{cccccccc}
\toprule
...
In this section, we demonstrate the real-time localization of the Thymio using different grayscale images of 59\,$\times$\,42\,cm, printed on A2 paper sheets.
We used Markov Localization discretization angle of 36.
The localization is performed every 0.4\,s.
