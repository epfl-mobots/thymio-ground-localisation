...
Finally, we demonstrate the real-time localisation of a Thymio robot on grayscale images used as ground patterns.
...
The robot moves with a speed of 3--5\,cm/s on a 150$\times$150\,cm ground pattern containing 50\,$\times$\,50 cells of 3$\times$3\,cm, each randomly black or white (\fig{thymio}, left). %FIXME: random_long is faster
...
Finally, we demonstrate the real-time localisation of the Thymio using different grayscale images, printed on A2 paper sheets.
